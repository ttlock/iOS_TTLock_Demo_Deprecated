...
+(id)loginWithUsername:(NSString*)username
    ...
    if (!errmsg) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            UIAlertView *alterView = [[UIAlertView alloc]initWithTitle:errmsg?errmsg:@"unkown error" message:nil delegate:self cancelButtonTitle:nil otherButtonTitles:@"words_sure_ok", nil];
            [alterView show];
        });
