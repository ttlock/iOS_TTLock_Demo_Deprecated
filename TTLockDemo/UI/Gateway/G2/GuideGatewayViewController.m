...
- (void)setupView{
    ...
    describeLabel.text = LS(@"tint_The_light_will_flash_alternately_within_60s");
    [self.view addSubview:describeLabel];
    
    RoundCornerButton *nextButton = [RoundCornerButton buttonWithTitle:LS(@"words_next") cornerRadius:4 borderWidth:0.5];
    ...
    [imageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.view).offset(30+ 80);
    }];
