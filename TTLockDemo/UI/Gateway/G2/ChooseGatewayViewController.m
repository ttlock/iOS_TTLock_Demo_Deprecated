...
- (void)viewDidAppear:(BOOL)animated{
    ...
    [TTLockGateway startScanGatewayWithBlock:^(TTGatewayScanModel *model) {
        if (model.RSSI == 127) {
            return ;
        }
...
- (void)viewDidLoad {
    ...
    self.title = LS(@"words_Choose_Gateway");
}
- (void)reloadView{
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [TTLockGateway connectGatewayWithGatewayMac:model.gatewayMac block:^(TTGatewayConnectStatus connectStatus) {
